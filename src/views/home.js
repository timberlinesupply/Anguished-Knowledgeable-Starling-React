...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Anguished Knowledgeable Starling</title>
        <meta property="og:title" content="Anguished Knowledgeable Starling" />
      </Helmet>
        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav3 bodySmall">Products</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav31 bodySmall">Products</span>
      ...
      <div className="home-hero">
        <div className="heroContainer home-hero1">
          <img
            alt="Timberline Van"
            src="https://cdn.shopify.com/s/files/1/0379/1994/8939/files/RoadmapHero.png?v=1706161985"
          ...
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Discover the Best in</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>Discover what sets us apart</span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: ' ',
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="A visually appealing banner at the top of the page"
              ></FeatureCard>
              <FeatureCard
                heading="Blocks of Text"
                subHeading="Five sections of informative text"
              ></FeatureCard>
              <FeatureCard
                heading="Roadmap Image"
                subHeading="An image displaying the roadmap of our product"
              ></FeatureCard>
              <FeatureCard
                heading="Hot Spots"
                subHeading="Interactive points on the roadmap image"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  At Our Company, we strive to provide the highest quality
                  products and services to our customers. With a team of experts
                  and a commitment to innovation, we are dedicated to delivering
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Our mission is to provide high-quality products and services to our customers."
              ...
              ></Question1>
              <Question1
                answer="Our products are known for their superior quality and innovative features."
                question="What sets your products apart from competitors?"
              ></Question1>
              <Question1
                answer="Yes, we offer a comprehensive warranty on all our products."
                question="Do you offer any warranties or guarantees on your products?"
              ></Question1>
              <Question1
                answer="You can reach our customer support team by phone, email, or through our website's live chat feature."
